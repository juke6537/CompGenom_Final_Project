...
#Plotting all three gene line plots together: 
```{r plotting}
...
# (1) Create a named vector for gene ID to gene name mapping
gene_labels <- c(
...
# (2) Modify the plot to use these names in facet_wrap
...
ggplot(plot_df, aes(x = time, y = avg)) +
  ...
  ggtitle('Gene Rps27rt Across Time')
```  
