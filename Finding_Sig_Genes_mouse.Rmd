...
kable(filtered_res_df, caption = "All significant genes across time points (Mouse)") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))

output_dir <- "/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/juke6537/MASTER_CLASS/lessons/06_Differential_expression_analyses/project/Project2_files"

filtered_res_df_mouse <- filtered_res_df

# Write the filtered DESeq2 results to CSV
write.csv(filtered_res_df_mouse, file.path(output_dir, "filtered_deseq_results_mouse.csv"), row.names = FALSE)

```

## Filtering to significant results P <0.05 and LFC abs(1)
```{r filtering DESEQ results to LFC > abs(2)& P <0.05}
...
kable(unique_sig_genes, caption = "All significant genes across time points (Mouse)") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))

output_dir <- "/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/juke6537/MASTER_CLASS/lessons/06_Differential_expression_analyses/project/Project2_files"

filtered_res_df_mouse <- unique_sig_genes
